...
<Steps>
  ...
  <Step title="Start Shift Server" stepNumber={2}>
    ...
    <Note>
      You may shutdown the server by using `:shutdown` to stop the shift. This will also stop teleportation from the hub.
    </Note>
  </Step>
  <Step title="Operating Shift">
    ...
    <Card title="Learn About Btools" icon="building" href="adonis/adonis#btools-command">
