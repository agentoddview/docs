...
- **Coach first**: Whenever possible, issue a constructive warning, explaining what was wrong, why it’s wrong, and how the player can avoid repeating it. As training material suggests, helping moderators shift from simply punishing to educating improves long-term culture. [SupportZebra+2Nightfall AI+2](https://supportzebra.com/blog/guide-to-training-content-moderators-for-success?utm_source=chatgpt.com)
...
- **Be calm and consistent** — As one training guide notes, supervisors often face a mix of situations; maintaining a professional demeanour helps. [ERC+1](https://yourerc.com/training/supervisor/ultimate-guide-to-training-supervisors/?utm_source=chatgpt.com)
